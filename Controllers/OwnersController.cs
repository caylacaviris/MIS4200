...
namespace Caviris_MIS4200.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ownerID,firstName,lastName,phoneNumber")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ownerID,firstName,lastName,phoneNumber")] Owner owner)
        {
            if (ModelState.IsValid)
            {
