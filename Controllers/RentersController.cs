...
namespace Caviris_MIS4200.Controllers
{
    public class RentersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "renterID,firstName,lastName,phoneNumber,birthday")] Renter renter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "renterID,firstName,lastName,phoneNumber,birthday")] Renter renter)
        {
            if (ModelState.IsValid)
            {
